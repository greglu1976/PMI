...
from part_SWITCH import part_SWITCH
...
class PartOfSwitchGUI:
    def __init__(self, root):
        ...
        self.sgf_params = {
            ...
            "SGF9_rcbf1_lvcbsup": tk.IntVar(value=0),
    ...
    def create_widgets(self):
        ...
        outputs = [
            ...
            "v_vkluchen_xcbr1_tsd", "v_neisp_pol_xcbr1_tsd", "v_otkluchit_rele_xcbr1_tsd", "v_vkluchit_rele_xcbr1_tsd"
        ]
    ...
    def init_part(self):
        self.part = part_SWITCH(
            ...
            SGF9_rcbf1_lvcbsup=self.sgf_params["SGF9_rcbf1_lvcbsup"].get(),
