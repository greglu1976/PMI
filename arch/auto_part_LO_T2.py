...
from lib._PARTS.LO_T2 import part_LO 
...
class PartLO_GUI:
    def __init__(self, root):
        ...
        self.sgf_params = {
            ...
            "SGF14_tsa": tk.IntVar(value=0), # 11
            "SGF15_tsa": tk.IntVar(value=0), # 12
            "SGF16_tsa": tk.IntVar(value=0), # 13
            "SGF17_tsa": tk.IntVar(value=0), # 14           
            ...
            #"SGF11_lvalh": tk.IntVar(value=0), # 15
            #"SGF12_lvalh": tk.IntVar(value=0), # 16
            #"SGF13_lvalh": tk.IntVar(value=0), # 17
            #"SGF14_lvalh": tk.IntVar(value=0), # 18
        }
    ...
    def init_part(self):
        self.part = part_LO(
            ...
            SGF14_tsa=self.sgf_params["SGF14_tsa"].get(), ##
            SGF15_tsa=self.sgf_params["SGF15_tsa"].get(), ##
            SGF16_tsa=self.sgf_params["SGF16_tsa"].get(), ##
            SGF17_tsa=self.sgf_params["SGF17_tsa"].get(), ##            
