...
from lib._PARTS.TECH_T2 import part_TECH_T2 
...
class PartOfTECH_T2_GUI:
    def __init__(self, root):
        ...
        self.sgf_params = {
            ...
            "SGF14_tsa": tk.IntVar(value=0),
            "SGF15_tsa": tk.IntVar(value=0),
            "SGF16_tsa": tk.IntVar(value=0),
            "SGF17_tsa": tk.IntVar(value=0),            
        }
    ...
    def init_part(self):
        self.part = part_TECH_T2(
            ...
            SGF14_t_signassembly=self.sgf_params["SGF14_tsa"].get(),
            SGF15_t_signassembly=self.sgf_params["SGF15_tsa"].get(),
            SGF16_t_signassembly=self.sgf_params["SGF16_tsa"].get(),
            SGF17_t_signassembly=self.sgf_params["SGF17_tsa"].get(),            
        )
        print("part_TECH_T2 initialized")

    def start_polling(self):
        if not self.part:
            print("part_TECH_T2 not initialized")
            return
