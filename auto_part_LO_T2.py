...
class PartLO_GUI:
    ...
    OUTPUT_PARAMS = [
            "T2_LVTTOC_1_LVTTOC_Str", "T2_LVTTOC_1_PTOC1_Op", "T2_LVTTOC_1_PTOC2_Op", "T2_LVTTOC_1_PTOC3_Op", "T_LVTOC_1_PTOC1_Str", "T_LVTOC_1_PTOC1_Op",
            "TRESOFFLVLGC_1_PTRC1_FuncEnabled", "TRESOFFLVLGC_1_PTRC1_FuncOperDisabled", "TRESOFFLVLGC_1_PTRC1_Op", "TRESOFFLVLGC_1_LVCBRBLC1_FuncEnabled", "TRESOFFLVLGC_1_LVCBRBLC1_FuncOperDisabled", "TRESOFFLVLGC_1_LVCBRBLC1_BlkOp", "TRESOFFLVLGC_1_RBRE1_FuncEnabled", "TRESOFFLVLGC_1_RBRE1_FuncOperDisabled", "TRESOFFLVLGC_1_RBRE1_BlkOp",
            "HVTCBOFF_1_HVCBPTRC1_FuncEnabled", "HVTCBOFF_1_HVCBPTRC1_FuncOperDisabled", "HVTCBOFF_1_HVCBPTRC1_Op", "HVTCBOFF_1_HVCBPTRC1_Tr",
            "LVTRESCBOFF1_1_LVCBPTRC1_FuncEnabled", "LVTRESCBOFF1_1_LVCBPTRC1_FuncOperDisabled", "LVTRESCBOFF1_1_LVCBPTRC1_Op", "LVTRESCBOFF1_1_LVCBPTRC1_Tr", "LVTRESCBOFF1_1_LVCBRECRBRE1_FuncEnabled", "LVTRESCBOFF1_1_LVCBRECRBRE1_FuncOperDisabled", "LVTRESCBOFF1_1_LVCBRECRBRE1_BlkOp", "LVTRESCBOFF1_1_LVBTSRBLC1_FuncEnabled", "LVTRESCBOFF1_1_LVBTSRBLC1_FuncOperDisabled", "LVTRESCBOFF1_1_LVBTSRBLC1_BlkOp",
            "LVTRESCBOFF2_1_LVCBPTRC1_FuncEnabled", "LVTRESCBOFF2_1_LVCBPTRC1_FuncOperDisabled", "LVTRESCBOFF2_1_LVCBPTRC1_Op", "LVTRESCBOFF2_1_LVCBPTRC1_Tr", "LVTRESCBOFF2_1_LVCBRECRBRE1_FuncEnabled", "LVTRESCBOFF2_1_LVCBRECRBRE1_FuncOperDisabled", "LVTRESCBOFF2_1_LVCBRECRBRE1_BlkOp", "LVTRESCBOFF2_1_LVBTSRBLC1_FuncEnabled", "LVTRESCBOFF2_1_LVBTSRBLC1_FuncOperDisabled", "LVTRESCBOFF2_1_LVBTSRBLC1_BlkOp",
            "T_LVCBSUP_1_RCBF1_BlkToOpn",
            ...
            "T2_SignAssembly_1_GASSign", "T2_SignAssembly_1_GASBlock", "T2_SignAssembly_1_LowIsolGAS", "T2_SignAssembly_1_OpExt", "T2_SignAssembly_1_CtlCir", "T2_SignAssembly_1_TestBlock", "T2_SignAssembly_1_OCSign", "T2_SignAssembly_1_GAS_OCControlSignAssem", "T2_SignAssembly_1_OCcir_CBSignAssem", "T2_SignAssembly_1_OCnnSign", "T2_SignAssembly_1_SwOperExcTim", "T2_SignAssembly_1_ExtSignGen",
    ...
    def __init__(self, root):
        ...
        self.sgf_params = {
            ...
            "T2_LVTTOC_1_PTOC1_ExtVFlMod": tk.IntVar(value=0),
            ...
            "T2_LVTTOC_1_PTOC2_ExtVFlMod": tk.IntVar(value=0),
            ...
            "T2_LVTTOC_1_PTOC3_ExtVFlMod": tk.IntVar(value=0),
            ...
            "LVTRESCBOFF1_1_LVCBPTRC1_EnaDis": tk.IntVar(value=0), # 5
            "LVTRESCBOFF1_1_LVCBRECRBRE1_EnaDis": tk.IntVar(value=0), # 6
            "LVTRESCBOFF1_1_LVBTSRBLC1_EnaDis": tk.IntVar(value=0), # 7
            "LVTRESCBOFF2_1_LVCBPTRC1_EnaDis": tk.IntVar(value=0), # 8
            "LVTRESCBOFF2_1_LVCBRECRBRE1_EnaDis": tk.IntVar(value=0), # 9
            "LVTRESCBOFF2_1_LVBTSRBLC1_EnaDis": tk.IntVar(value=0),   # 10     
        ...
        self.settings = {
            ...
            "T2_LVTTOC_1_PTOC1_IopCoars": tk.DoubleVar(value=1),
            "T2_LVTTOC_1_PTOC2_Top": tk.DoubleVar(value=1),
            "T2_LVTTOC_1_PTOC2_Iop": tk.DoubleVar(value=0.2),
            "T2_LVTTOC_1_PTOC2_IopCoars": tk.DoubleVar(value=1),
            "T2_LVTTOC_1_PTOC3_Top": tk.DoubleVar(value=1),            
            "T2_LVTTOC_1_PTOC3_Iop": tk.DoubleVar(value=0.2),
            "T2_LVTTOC_1_PTOC3_IopCoars": tk.DoubleVar(value=1),
            "T2_LVTTOC_1_PTUV1_Uop": tk.DoubleVar(value=40),            
            "T2_LVTTOC_1_PTUV1_U2op": tk.DoubleVar(value=5),
            "T2_LVTTOC_1_PTUV2_Uop": tk.DoubleVar(value=40),  ##           
            "T2_LVTTOC_1_PTUV2_U2op": tk.DoubleVar(value=5), ##
            ...
            "T_TPBRF_1_GENRBRF1_Iop": tk.DoubleVar(value=0.5),
            "HVTCBOFF_1_HVCBPTRC1_Tpulse": tk.DoubleVar(value=1),
            "LVTRESCBOFF1_1_LVCBPTRC1_Tpulse": tk.DoubleVar(value=1), # 19
            "LVTRESCBOFF2_1_LVCBPTRC1_Tpulse": tk.DoubleVar(value=1), # 20           
        }
        ...
        self.input_vars = {
            ...
            "T2_PNL_1_CtlCirSwPos1": tk.IntVar(value=0),
            "T2_PNL_1_CtlCirSwPos2": tk.IntVar(value=0),
            "T2_PNL_1_CtlCirSwPos3": tk.IntVar(value=0),
            "T2_PNL_1_CtlCirSwPos4": tk.IntVar(value=0),
            "T2_PNL_1_CtlCirSwPos5": tk.IntVar(value=0),
            "T2_PNL_1_CtlCirSwPos6": tk.IntVar(value=0),  ##           
            "T2_PNL_1_TestBlockPos1": tk.IntVar(value=0),
            "T2_PNL_1_TestBlockPos2": tk.IntVar(value=0),
            "T2_PNL_1_TestBlockPos3": tk.IntVar(value=0),   ##          
            ...
            "IEDvt_OCControl1": tk.IntVar(value=0), ##
            "IEDvt_OCControl2": tk.IntVar(value=0),  ##           
    ...
    def init_part(self):
        self.part = part_LO(
            ...
            SGF1_lvcbptrc1_lvtcboff1=self.sgf_params["LVTRESCBOFF1_1_LVCBPTRC1_EnaDis"].get(), ##
            SGF1_lvcbrecrbre1_lvtcboff1=self.sgf_params["LVTRESCBOFF1_1_LVCBRECRBRE1_EnaDis"].get(), ##
            SGF1_lvbtsrblc1_lvtcboff1=self.sgf_params["LVTRESCBOFF1_1_LVBTSRBLC1_EnaDis"].get(), ##
            SGF1_lvcbptrc1_lvtcboff2=self.sgf_params["LVTRESCBOFF2_1_LVCBPTRC1_EnaDis"].get(), ##
            SGF1_lvcbrecrbre1_lvtcboff2=self.sgf_params["LVTRESCBOFF2_1_LVCBRECRBRE1_EnaDis"].get(), ##
            SGF1_lvbtsrblc1_lvtcboff2=self.sgf_params["LVTRESCBOFF2_1_LVBTSRBLC1_EnaDis"].get(), ##          
            ...
            T1_ptoc1_lvtoc=self.settings["T_LVTOC_1_PTOC1_Top"].get()/1000,
            ...
            T1_lvcbptrc1_lvtcboff1=self.settings["LVTRESCBOFF1_1_LVCBPTRC1_Tpulse"].get()/1000, ##
            T1_lvcbptrc1_lvtcboff2=self.settings["LVTRESCBOFF2_1_LVCBPTRC1_Tpulse"].get()/1000, ##            
        )
