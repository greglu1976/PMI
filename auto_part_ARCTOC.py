...
from lib._FBS.ARCTOC import ARCTOC

class ARCTOC_GUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Тестирование ЗДЗ ОЛ. вер.0.1 от 14.08.25")
        self.part = None
        ...
        self.sgf_params = {
            "SGF1_arcptoc1_arctoc": tk.IntVar(value=0),
            "SGF2_arcptoc1_arctoc": tk.IntVar(value=0),
            "SGF3_arcptoc1_arctoc": tk.IntVar(value=0),
            "SGF4_arcptoc1_arctoc": tk.IntVar(value=0),
        }

        # Настройки (T-параметры)
        self.settings = {
            "T1_arcptoc1_arctoc": tk.DoubleVar(value=1),
            "T2_arcptoc1_arctoc": tk.DoubleVar(value=3),            
            "Iset_arcptoc1_arctoc": tk.DoubleVar(value=0.2),
            "U0set_arcptoc1_arctoc": tk.DoubleVar(value=10),
        }

        # Входные параметры для Step()
        self.input_vars = {
            "VYVOD": tk.IntVar(value=0),
            "OV_ZDZ": tk.IntVar(value=0),
            "NaSign_ZDZ": tk.IntVar(value=0),
            "SrabZDZ": tk.IntVar(value=0),
            "BNNshSrab": tk.IntVar(value=0),
            "KtrTokZDZ": tk.IntVar(value=0),            
    ...
    def create_widgets(self):
        ...
        outputs = ["vvod", "oper_vyvod", "ZDZ_neispr", "ZDZ_srab", "ZDZ_srabsign", "pusk", "uo", "io_max", "U0"]
    ...
    def init_part(self):
        self.part = ARCTOC(
            ...
            SGF1_arcptoc1_arctoc=self.sgf_params["SGF1_arcptoc1_arctoc"].get(),
            SGF2_arcptoc1_arctoc=self.sgf_params["SGF2_arcptoc1_arctoc"].get(),
            SGF3_arcptoc1_arctoc=self.sgf_params["SGF3_arcptoc1_arctoc"].get(),
            SGF4_arcptoc1_arctoc=self.sgf_params["SGF4_arcptoc1_arctoc"].get(),
          
            T1_arcptoc1_arctoc=self.settings["T1_arcptoc1_arctoc"].get(),
            T2_arcptoc1_arctoc=self.settings["T2_arcptoc1_arctoc"].get(),

            Iset_arcptoc1_arctoc=self.settings["Iset_arcptoc1_arctoc"].get(),
            U0set_arcptoc1_arctoc=self.settings["U0set_arcptoc1_arctoc"].get(),         
        )
