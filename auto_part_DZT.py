...
class PartDZT_GUI:
    ...
    def __init__(self, root):
        ...
        self.sgf_params = {
            "Side1": tk.IntVar(value=1),
            "Side2": tk.IntVar(value=1),
            "Side3": tk.IntVar(value=0),
            "k_sch_1": tk.IntVar(value=0),
            "k_sch_2": tk.IntVar(value=0), 
            "compens_3i0_vn": tk.IntVar(value=0),
            "compens_3i0_nn": tk.IntVar(value=0), 
        ...
        self.settings = {
            ...
            "Sbaz": tk.DoubleVar(value=10e+6),
            "Ubaz_vn": tk.DoubleVar(value=36750),
            "Ubaz_nn": tk.DoubleVar(value=10500),
            "Iperv_vn": tk.DoubleVar(value=1000),
            "Iperv_nn": tk.DoubleVar(value=5000),
            "Inom_term_vn": tk.DoubleVar(value=1),
            "Inom_term_nn": tk.DoubleVar(value=1),
            "Ivtor_vn": tk.DoubleVar(value=1),
            "Ivtor_nn": tk.DoubleVar(value=5),
            "n_sch_vn": tk.DoubleVar(value=0),
            "n_sch_nn": tk.DoubleVar(value=0),
    ...
    def init_part(self):
        self.part = partDZT(
            Side1=self.sgf_params["Side1"].get(),
            Side2=self.sgf_params["Side2"].get(),
            Side3=self.sgf_params["Side3"].get(),                        
            ...
            k_sch_vn = self.sgf_params["k_sch_1"].get(),
            k_sch_nn = self.sgf_params["k_sch_2"].get(),
            compens_3i0_vn = self.sgf_params["compens_3i0_vn"].get(),
            compens_3i0_nn = self.sgf_params["compens_3i0_nn"].get(),
            ...
            Sbaz = self.settings["Sbaz"].get(),
            Ubaz_vn = self.settings["Ubaz_vn"].get(),
            Ubaz_nn = self.settings["Ubaz_nn"].get(),
            Iperv_vn = self.settings["Iperv_vn"].get(),
            Iperv_nn = self.settings["Iperv_nn"].get(),
            Inom_term_vn = self.settings["Inom_term_vn"].get(),
            Inom_term_nn = self.settings["Inom_term_nn"].get(),
            Ivtor_vn = self.settings["Ivtor_vn"].get(),
            Ivtor_nn = self.settings["Ivtor_nn"].get(),

            n_sch_vn = self.settings["n_sch_vn"].get(),
            n_sch_nn = self.settings["n_sch_nn"].get(),
