# (DZT2_LVALH) Функция ПС - предупредительная сигнализация трансформатора 35 кВ
...
class DZT2_LVALH:
    def __init__(self, SGF1=0, SGF2=0, SGF3=0, SGF4=0, SGF5=0, SGF6=0, SGF7=0, SGF8=0, SGF9=0, SGF10=0, SGF11=0, SGF12=0, SGF13=0):
        ...
        self.SGF12 = SGF12
        self.SGF13 = SGF13
    def Step(self, VYVOD = 0, COMM_SIGN = (0,), sgf1_sign = 0, sgf2_sign = 0, sgf3_sign = 0, sgf4_sign = 0, sgf5_sign = 0, sgf6_sign = 0, sgf7_sign = 0, sgf8_sign = 0, sgf9_sign = 0, sgf10_sign = 0, sgf11_sign = 0, sgf12_sign = 0, sgf13_sign = 0):
