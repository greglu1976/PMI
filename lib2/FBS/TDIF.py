...
from lib2.FUNCS.HF2DIFPHAR import HF2DIFPHAR
from lib2.FUNCS.ATDIFRCTR import ATDIFRCTR
from lib2.FUNCS.INSPDIF import INSPDIF
from lib2.FUNCS.RESPDIF import RESPDIF
from lib2.FUNCS.BLKRCTR import BLKRCTR # заглушка вместо БВКЗ
from lib2.ADD.calc_diff_bias import CalcDiffBias # модуль задания исходных параметров сторон и выравнивания токов сторон
