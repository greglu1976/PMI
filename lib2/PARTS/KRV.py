...
class partKRV:
    ...
    def Step(self, DI_ControllerDisable, CBPosOpn, CBPosCls, CLS_1_ResetCounter, LocKey, IA, IB, IC, Reset, OperOpnCB):
        ...
        pusk_t_lvalh = self.t_lvalh.Step(VYVOD=DI_ControllerDisable, sign_ps_tuple=(CLS_1_CLS_CBLifeExcess, v_samoproisv_otkl_rcbf1_lvcbsup, neispr_V_rcbf1_lvcbsup, v_avar_otkl_rcbf1_lvcbsup))
