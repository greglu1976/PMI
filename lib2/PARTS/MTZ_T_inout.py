...
class partOfFsuInTOC:
    ...
    def Step(self, DI_ControllerDisable, LVTTOC_1_LVTTOC_operOutFunction, LVTTOC_1_SBnnPosCls, IA, dIA, IB, dIB, IC, dIC, LVTTOC_1_CBnnPosCls, 
        LVTTOC_1_PTOC1_operOutLevel, LVTTOC_1_PTOC1_OpOnSignal,
        LVTTOC_1_PTOC2_operOutLevel, LVTTOC_1_PTOC2_OpOnSignal,
        LVTTOC_1_PTOC3_operOutLevel, LVTTOC_1_PTOC3_OpOnSignal,
        LVTTOC_1_OutVoltStr, UA1, dUA1, UB1, dUB1, UC1, dUC1,  
        IA2harm, IB2harm, IC2harm,
        LVRBVTR_1_LVRBVTR_operOutFunction, LVRBVTR_1_OutBlkV,
        TOFFLVLGC_1_TOFFLVLGC_operOutFunction, TOFFLVLGC_1_PTRC1_operOutLevel, TOFFLVLGC_1_RBRE1_operOutLevel, TOFFLVLGC_1_LVCBRBLC1_operOutLevel,
        ):
        ...
        # вычисляем КЦН НН
        vvod_lvrbvtr1, oper_vyvod_lvrbvtr1, u_lin_pusk_lvrbvtr1, u2_pusk_lvrbvtr1, pusk_lvrbvtr1, neispr_zn_lvrbvtr1 = self.lvrbvtr1.Step(DI_ControllerDisable, LVRBVTR_1_LVRBVTR_operOutFunction, LVRBVTR_1_OutBlkV, UAB_ptuv1, UBC_ptuv1, UCA_ptuv1, U2_ptuv1)
        ...
        # вычисляем МТЗ
        vvod_ptoc1_lvttoc, oper_vyvod_ptoc1_lvttoc, mtzA_pusk_ptoc1_lvttoc, mtzB_pusk_ptoc1_lvttoc, mtzC_pusk_ptoc1_lvttoc, gen_pusk_ptoc1_lvttoc, mtz_srabsign_ptoc1_lvttoc, mtz_srab_ptoc1_lvttoc, io_A_ptoc1_lvttoc, io_B_ptoc1_lvttoc, io_C_ptoc1_lvttoc, vvod_ptoc2_lvttoc, oper_vyvod_ptoc2_lvttoc, mtzA_pusk_ptoc2_lvttoc, mtzB_pusk_ptoc2_lvttoc, mtzC_pusk_ptoc2_lvttoc, gen_pusk_ptoc2_lvttoc, mtz_srabsign_ptoc2_lvttoc, mtz_srab_ptoc2_lvttoc, io_A_ptoc2_lvttoc, io_B_ptoc2_lvttoc, io_C_ptoc2_lvttoc, vvod_ptoc3_lvttoc, oper_vyvod_ptoc3_lvttoc, mtzA_pusk_ptoc3_lvttoc, mtzB_pusk_ptoc3_lvttoc, mtzC_pusk_ptoc3_lvttoc, gen_pusk_ptoc3_lvttoc, mtz_srabsign_ptoc3_lvttoc, mtz_srab_ptoc3_lvttoc, io_A_ptoc3_lvttoc, io_B_ptoc3_lvttoc, io_C_ptoc3_lvttoc, kpon_pusk_ptuv1_lvttoc, ia_start_out_phar1_lvttoc, ib_start_out_phar1_lvttoc, ic_start_out_phar1_lvttoc, start_phar1_lvttoc, blok_rblc1_lvttoc, mtz_pusk_lvttoc = self.lvttoc.Step(DI_ControllerDisable, LVTTOC_1_LVTTOC_operOutFunction, LVTTOC_1_SBnnPosCls, IA, IAB, IB, IBC, IC, ICA, neispr_zn_lvrbvtr1, LVTTOC_1_CBnnPosCls, LVTTOC_1_PTOC1_operOutLevel, LVTTOC_1_PTOC1_OpOnSignal, LVTTOC_1_PTOC2_operOutLevel, LVTTOC_1_PTOC2_OpOnSignal, LVTTOC_1_PTOC3_operOutLevel, LVTTOC_1_PTOC3_OpOnSignal, LVTTOC_1_OutVoltStr, UAB_ptuv1, UBC_ptuv1, UCA_ptuv1, U2_ptuv1, IA2harm, IB2harm, IC2harm)
        ...
        # вычисляем ЛО Т
        vvod_ptrc1, oper_vyvod_ptrc1, pusk_ptrc1, srab_ptrc1, vvod_rblc1, oper_vyvod_rblc1, zapret_rblc1, vvod_rbre1, oper_vyvod_rbre1, zapret_rbre1 = self.tofflvlgc.Step(DI_ControllerDisable, TOFFLVLGC_1_TOFFLVLGC_operOutFunction, TOFFLVLGC_1_PTRC1_operOutLevel, (mtz_srab_ptoc1_lvttoc,), mtz_srab_ptoc2_lvttoc, mtz_srab_ptoc3_lvttoc, TOFFLVLGC_1_RBRE1_operOutLevel, TOFFLVLGC_1_LVCBRBLC1_operOutLevel)
        # вычисляем ПС
