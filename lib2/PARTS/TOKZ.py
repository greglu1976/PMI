...
class partTOKZ:
    ...
    DI_TTOCLGC, ExtTLGCPTRCStr, BlkLPT,
    DI_TOFFLVLGC, DI_PTRC1, DI_RBRE1, DI_LVCBRBLC1,
        ...
        # Рассчитываем ЗП
        vvod_hvptoc1_lovctoc, oper_vyvod_hvptoc1_lovctoc, pusk_hvptoc1_lovctoc, io_hvptoc1_lovctoc, srab_hvptoc1_lovctoc, srabotkl_hvptoc1_lovctoc, ET_hvptoc1_lovctoc = self.tovctoc.Step(DI_ControllerDisable, DI_AUTOVC, DI_AUTOVC_Sign, IA, IB, IC)
        # Рассчитываем ТК ЗДЗ
        ...
        # Рассчитываем ЛЗТ
        vvod_ptrc1_ttoclgc, oper_vyvod_ptrc1_ttoclgc, pusk_ptrc1_ttoclgc, srab_ptrc1_ttoclgc, ET_ptrc1_ttoclgc =  self.ttoclgc.Step(DI_ControllerDisable, DI_TTOCLGC, ExtTLGCPTRCStr, LVTTOC_1_PTOC2_Str, LVTTOC_1_PTOC3_Str, BlkLPT)       
        # Рассчитываем ЛО Т
