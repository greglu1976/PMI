...
class part_TECH_T:
    ...
    def Step(self, DI_ControllerDisable, DI_APTTECHLGC, DI_OILPTRC1, DI_WINPTRC1, DI_VLVPTRC1, DI_OILPTRC1_Sign, DI_WINPTRC1_Sign, DI_VLVPTRC1_Sign, srabKontOtkl_m, srabKontSign_m, srabKontOtkl_o, srabKontSign_o, srabKontOtkl_rd, srabKI_m, srabKI_o, srabKI_rd, Sbros, DI_ALMTECHLGC, DI_PRVLVPTRC1, DI_SHVLVPTRC1, DI_LEVPTRC1, DI_PRV_Sign, DI_SHV_Sign, DI_LEV_Sign, srabKontOtkl_pk, srabKontOtkl_ok, srabKontOtkl_lev, DI_TALMGASLGC, DI_TALMGASLGC_Sign, srabKont_ptrc1_talmgaslgc, srabKI_ptrc1_talmgaslgc, DI_TTRGASLGC, DI_TTRGASLGC_Sign, srabKont_ptrc1_ttrgaslgc, srabKI_ptrc1_ttrgaslgc, DI_TLTCGASLGC, DI_TLTCGASLGC_Sign, srabKont_ptrc1_tltcgaslgc, srabKI_ptrc1_tltcgaslgc, DI_TOFFLVLGC, DI_PTRC1, DI_RBRE1, DI_LVCBRBLC1, oil_t_hi_level, oil_ltc_hi_level, oil_ltc_lo_level, oil_ltc_lo_temp
        ):
        # Вычисляем ТЗ
        vvod_oilptrc1_apttechlgc, oper_vyvod_oilptrc1_apttechlgc, srab_oilptrc1_apttechlgc, srabsign_oilptrc1_apttechlgc, zablok_oilptrc1_apttechlgc, ET_oilptrc1_apttechlgc, vvod_winptrc1_apttechlgc, oper_vyvod_winptrc1_apttechlgc, srab_winptrc1_apttechlgc, srabsign_winptrc1_apttechlgc, zablok_winptrc1_apttechlgc, ET_winptrc1_apttechlgc, vvod_vlvptrc1_apttechlgc, oper_vyvod_vlvptrc1_apttechlgc, srab_vlvptrc1_apttechlgc, srabsign_vlvptrc1_apttechlgc, zablok_vlvptrc1_apttechlgc, ET_vlvptrc1_apttechlgc = self.apttechlgc.Step(DI_ControllerDisable, DI_APTTECHLGC, DI_OILPTRC1, DI_WINPTRC1, DI_VLVPTRC1, DI_OILPTRC1_Sign, DI_WINPTRC1_Sign, DI_VLVPTRC1_Sign, srabKontOtkl_m, srabKontSign_m, srabKontOtkl_o, srabKontSign_o, srabKontOtkl_rd, srabKI_m, srabKI_o, srabKI_rd, Sbros)
        # Вычисляем ТС
        vvod_prvlvptrc1_almtechlgc, oper_vyvod_prvlvptrc1_almtechlgc, srab_prvlvptrc1_almtechlgc, srabsign_prvlvptrc1_almtechlgc, vvod_shvlvptrc1_almtechlgc, oper_vyvod_shvlvptrc1_almtechlgc, srab_shvlvptrc1_almtechlgc, srabsign_shvlvptrc1_almtechlgc, vvod_levptrc1_almtechlgc, oper_vyvod_levptrc1_almtechlgc, srab_levptrc1_almtechlgc, srabsign_levptrc1_almtechlgc = self.almtechlgc.Step(DI_ControllerDisable, DI_ALMTECHLGC, DI_PRVLVPTRC1, DI_SHVLVPTRC1, DI_LEVPTRC1, DI_PRV_Sign, DI_SHV_Sign, DI_LEV_Sign, srabKontOtkl_pk, srabKontOtkl_ok, srabKontOtkl_lev)
        # Вычисляем ГЗ сигн
        vvod_ptrc1_talmgaslgc, oper_vyvod_ptrc1_talmgaslgc, srab_ptrc1_talmgaslgc, srabsign_ptrc1_talmgaslgc, zablok_ptrc1_talmgaslgc, ET_ptrc1_talmgaslgc = self.talmgaslgc.Step(DI_ControllerDisable, DI_TALMGASLGC, DI_TALMGASLGC_Sign, srabKont_ptrc1_talmgaslgc, srabKI_ptrc1_talmgaslgc, Sbros)
        # Вычисляем ГЗ откл
        OV_f = 0
        vvod_ptrc1_ttrgaslgc, oper_vyvod_ptrc1_ttrgaslgc, srab_ptrc1_ttrgaslgc, srabsign_ptrc1_ttrgaslgc, zablok_ptrc1_ttrgaslgc, ET_ptrc1_ttrgaslgc = self.ttrgaslgc.Step(DI_ControllerDisable, DI_TTRGASLGC, OV_f, DI_TTRGASLGC_Sign, srabKont_ptrc1_ttrgaslgc, srabKI_ptrc1_ttrgaslgc, Sbros)
        # Вычисляем ГЗ РПН
        vvod_ptrc1_tltcgaslgc, oper_vyvod_ptrc1_tltcgaslgc, srab_ptrc1_tltcgaslgc, srabsign_ptrc1_tltcgaslgc, zablok_ptrc1_tltcgaslgc, ET_ptrc1_tltcgaslgc = self.tltcgaslgc.Step(DI_ControllerDisable, DI_TLTCGASLGC, OV_f, DI_TLTCGASLGC_Sign, srabKont_ptrc1_tltcgaslgc, srabKI_ptrc1_tltcgaslgc, Sbros)
