...
class SWITCH:
    ...
    vnesh_otkl_zdz, vnesh_otkl_urov
        ...
        pusk_t_lvalh = self.t_lvalh.Step(VYVOD=VYVOD, sign_ps_tuple=(v_samoproisv_otkl_rcbf1_lvcbsup, neispr_V_rcbf1_lvcbsup, self.srab_na_sebya_rbrf1_tpbrf), sgf13_sign=ss_prev_vrem_per_ka)
