...
from lib2.FBS.CTR import CTR # импорт ФБ КЦТ
from lib2.FBS.TDIF import TDIF # импорт ФБ ДЗТ
from lib2.FBS.TPRMOFFLVLGC import TPRMOFFLVLGC # импорт ФБ ЛО Т (ДЗТ)
...
class partDZT:
    ...
    def Step(self, DI_ControllerDisable, DI_CTR_UIRZ, DI_CTR_RCTR1, IA, dIA, IB, dIB, IC, dIC, DI_CTR_RCTR2, DI_CTR_RCTR3, IA1, dIA1, IB1, dIB1, IC1, dIC1, DI_TDIF, DI_RESPDIF, DI_RESPDIF_Sign, DI_INSPDIF, DI_INSPDIF_Sign, IA2harm, IB2harm, IC2harm, IA5harm, IB5harm, IC5harm, DI_ATDIFRCTR, DI_TPRMOFFLVLGC, DI_TJNTPTRC, DI_JNTRBRE):
        ...
        dIB_nn2 = dIB1
        dIC_nn2 = dIC1
        vvod_pdif2_tdif, oper_vyvod_pdif2_tdif, pusk_A_pdif2_tdif, srab_A_pdif2_tdif, srabsign_A_pdif2_tdif, io_A_pdif2_tdif, pusk_B_pdif2_tdif, srab_B_pdif2_tdif, srabsign_B_pdif2_tdif, io_B_pdif2_tdif, pusk_C_pdif2_tdif, srab_C_pdif2_tdif, srabsign_C_pdif2_tdif, io_C_pdif2_tdif, pusk_pdif2_tdif, srabsign_pdif2_tdif, srab_pdif2_tdif, vvod_pdif1_tdif, oper_vyvod_pdif1_tdif, pusk_A_pdif1_tdif, srab_A_pdif1_tdif, srabsign_A_pdif1_tdif, io_A_pdif1_tdif, pusk_B_pdif1_tdif, srab_B_pdif1_tdif, srabsign_B_pdif1_tdif, io_B_pdif1_tdif, pusk_C_pdif1_tdif, srab_C_pdif1_tdif, srabsign_C_pdif1_tdif, io_C_pdif1_tdif, pusk_pdif1_tdif, srabsign_pdif1_tdif, srab_pdif1_tdif, pusk_A_hf2phar1_tdif, pusk_B_hf2phar1_tdif, pusk_C_hf2phar1_tdif, pusk_hf2phar1_tdif, pusk_A_hf5phar1_tdif, pusk_B_hf5phar1_tdif, pusk_C_hf5phar1_tdif, pusk_hf5phar1_tdif, vvod_rctr1_tdif, oper_vyvod_rctr1_tdif, srab_A_rctr1_tdif, srab_B_rctr1_tdif, srab_C_rctr1_tdif, srab_rctr1_tdif, neispr_rctr1_tdif, diffA, restA, diffB, restB, diffC, restC = self.tdif.Step(DI_ControllerDisable, IA, dIA, IB, dIB, IC, dIC, IA1_nn, dIA1, IB1_nn, dIB1, IC1_nn, dIC1, DI_TDIF, DI_INSPDIF, DI_INSPDIF_Sign, DI_RESPDIF, DI_RESPDIF_Sign, srab_ctr, IA2harm, IB2harm, IC2harm, IA5harm, IB5harm, IC5harm, DI_ATDIFRCTR, IA_nn2, dIA_nn2, IB_nn2, dIB_nn2, IC_nn2, dIC_nn2)

        vvod_ptrc1_tprmofflvlgc, oper_vyvod_ptrc1_tprmofflvlgc, pusk_ptrc1_tprmofflvlgc, srab_ptrc1_tprmofflvlgc, vvod_rbre1_tprmofflvlgc, oper_vyvod_rbre1_tprmofflvlgc, zapret_rbre1_tprmofflvlgc = self.tprmofflvlgc.Step(DI_ControllerDisable, DI_TPRMOFFLVLGC, DI_TJNTPTRC, (srab_pdif2_tdif, srab_pdif1_tdif), DI_JNTRBRE)

        pusk_lvalh = self.lvalh.Step(DI_ControllerDisable, COMM_SIGN = (srab_pdif2_tdif, srab_pdif1_tdif, srab_ctr, srab_rctr1_tdif, srabsign_pdif2_tdif, srabsign_pdif1_tdif))
