...
class PartOfTECH_DZT_GUI:
    ...
    def __init__(self, root):
        ...
        self.input_vars = {
            ...
            "DI_APTTECHLGC": tk.IntVar(value=0),
            "DI_OILPTRC": tk.IntVar(value=0),
            "DI_WINPTRC": tk.IntVar(value=0),
            "DI_VLVPTRC": tk.IntVar(value=0),
            "DI_OILPTRC_Sign": tk.IntVar(value=0),
            "DI_WINPTRC_Sign": tk.IntVar(value=0),
            "DI_VLVPTRC_Sign": tk.IntVar(value=0),
            "OILTempEmerg": tk.IntVar(value=0),
            "OILTempHigh": tk.IntVar(value=0),
            "WINTempEmerg": tk.IntVar(value=0),
            "WINTempHigh": tk.IntVar(value=0),
            "VLVop": tk.IntVar(value=0),
            "OILIsolOp": tk.IntVar(value=0),
            "WINIsolOp": tk.IntVar(value=0),
            "VLVIsolOp": tk.IntVar(value=0),
            "Reset": tk.IntVar(value=0),
            "DI_ALMTECHLGC": tk.IntVar(value=0),
            "DI_PRVLVPTRC1": tk.IntVar(value=0),
            "DI_SHVLVPTRC1": tk.IntVar(value=0),
            "DI_LEVPTRC1": tk.IntVar(value=0),
            "DI_PRVLVPTRC1_Sign": tk.IntVar(value=0),
            "DI_SHVLVPTRC1_Sign": tk.IntVar(value=0),
            "DI_LEVPTRC1_Sign": tk.IntVar(value=0),
            "PRVLVOp": tk.IntVar(value=0),
            "SHVLVOp": tk.IntVar(value=0),
            "LowOILLevel": tk.IntVar(value=0),
            "DI_TALMGASLGC": tk.IntVar(value=0),
            "DI_TALMGASLGC_Sign": tk.IntVar(value=0),
            "SignContact": tk.IntVar(value=0),
            "GASSignIsolOp": tk.IntVar(value=0),
            "DI_TTRGASLGC": tk.IntVar(value=0),
            "DI_TTRGASLGC_Sign": tk.IntVar(value=0),
            "TripContact": tk.IntVar(value=0),
            "GASTripIsolOp": tk.IntVar(value=0),
            "DI_TLTCGASLGC": tk.IntVar(value=0),
            "DI_TLTCGASLGC_Sign": tk.IntVar(value=0),
            "JetRelayContact": tk.IntVar(value=0),
            "GASLTCIsolOp": tk.IntVar(value=0),
            "DI_TPRMOFFLVLGC": tk.IntVar(value=0),
            "DI_TJNTPTRC": tk.IntVar(value=0),
            "DI_JNTRBRE": tk.IntVar(value=0),
            "HighOILLevel": tk.IntVar(value=0),
            "HighOILLevelLTC": tk.IntVar(value=0),
            "LowOILLevelLTC": tk.IntVar(value=0),
            "OILTempLowLTC": tk.IntVar(value=0),
            "FailCoolSys": tk.IntVar(value=0),
            "ProblemCoolSys": tk.IntVar(value=0),
