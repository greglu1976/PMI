...
class part_TECH_T2:
    ...
    def Step(self, VYVOD, Sbros, OV_ptrc1_talmgaslgc, NaOtkl_ptrc1_talmgaslgc, srabKont_ptrc1_talmgaslgc, srabKI_ptrc1_talmgaslgc, OV_ptrc1_ttrgaslgc, NaSign_ptrc1_ttrgaslgc, srabKont_ptrc1_ttrgaslgc, srabKI_ptrc1_ttrgaslgc, OV_ptrc1_tltcgaslgc, NaSign_ptrc1_tltcgaslgc, srabKont_ptrc1_tltcgaslgc, srabKI_ptrc1_tltcgaslgc, OV_tofflvlg, OVlo_tofflvlg, OVzapv_tofflvlg, OVzavr_tofflvlg):
