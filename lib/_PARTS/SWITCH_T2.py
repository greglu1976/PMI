...
from lib._FBS.T2_SignAssembly import T2_SignAssembly # импорт ФБ СС T2
from lib._FBS.T2_LVALH import T2_LVALH # импорт ФБ ПС
...
class SWITCH:
    ...
    SGF1_hvcbptrc1_hvtcboff, T1_hvcbptrc1_hvtcboff
        ...
        self.t_lvalh = T2_LVALH(SGF9=SGF9_t_lvalh)
    ...
    vnesh_otkl_zdz1, vnesh_otkl_urov1, vnesh_otkl_zdz2, vnesh_otkl_urov2
        ...
        vvod_hvcbptrc1_hvtcboff, oper_vyvod_hvcbptrc1_hvtcboff, otkl_hvcbptrc1_hvtcboff, otkl_avar_hvcbptrc1_hvtcboff = self.hvtcboff.Step(VYVOD, OV_hvcbptrc1_hvtcboff=0, LO_t_srab=0, vnesh_otkl_zdz=vnesh_otkl_zdz1 or vnesh_otkl_zdz2, vnesh_otkl_urov=vnesh_otkl_urov1 or vnesh_otkl_urov2)

        vvod_rcbf1_lvcbsup, oper_vyvod_rcbf1_lvcbsup, v_samoproisv_otkl_rcbf1_lvcbsup, neispr_V_rcbf1_lvcbsup, v_avar_otkl_rcbf1_lvcbsup, rfk_rcbf1_lvcbsup, blok_vkl_rcbf1_lvcbsup, blok_otkl_rcbf1_lvcbsup, neisp_emu_rcbf1_lvcbsup, zashita_emv_rcbf1_lvcbsup, zashita_emo1_rcbf1_lvcbsup, zashita_emo2_rcbf1_lvcbsup = self.lvcbsup.Step(VYVOD, OV_rcbf1_lvcbsup, ot_emo1emv, ot_emo2, otkl_hvcbptrc1_hvtcboff, self.srab_na_sebya_rbrf1_tpbrf, avar_isol_V, niz_isol_V, pruzh_ne_zaved, self.v_neisp_pol_xcbr1_tsd, self.v_otkluchen_xcbr1_tsd, self.v_vkluchen_xcbr1_tsd, Sbros, self.uv_otkluchit_cbcswi1_swctrl, otkl_ot_knopk, oper_otkl_V, KRV_resurs_V, vnesh_blok_upr_V, kontr_emv, kontr_emo1, kontr_emo2, rabota_emv, rabota_emo1, rabota_emo2)
        ...
        vvod_tds, oper_vyvod_tds,  vvod_xcbr1_tsd, v_prom_pol_xcbr1_tsd, self.v_otkluchen_xcbr1_tsd, self.v_vkluchen_xcbr1_tsd, self.v_neisp_pol_xcbr1_tsd, v_otkluchit_rele_xcbr1_tsd, v_vkluchit_rele_xcbr1_tsd = self.tsd.Step(VYVOD, OV_tsd, v_otkl_bk, v_vkl_bk, self.uv_otkluchit_cbcswi1_swctrl, otkl_avar_hvcbptrc1_hvtcboff, self.srab_na_sebya_rbrf1_tpbrf, oper_otkl_V, blok_otkl_rcbf1_lvcbsup, rabota_emo1, rabota_emo2, Sbros, uv_vkluchit_cbcswi1_swctrl, uv_vkl_cbcswi1_hvbctrl, rabota_emv)

        vvod_rbrf1_tpbrf, oper_vyvod_rbrf1_tpbrf, uskorenie_rbrf1_tpbrf, srab_rbrf1_tpbrf, pusk_rbrf1_tpbrf, io_rbrf1_tpbrf, self.srab_na_sebya_rbrf1_tpbrf = self.tpbrf.Step(VYVOD, OV_rbrf1_tpbrf=0, blok_otkl_rcbf1_lvcbsup=blok_otkl_rcbf1_lvcbsup, LO_VN_otkl=0, kontr_emo1=kontr_emo1, kontr_emo2=kontr_emo2, Puski=(0,0), pusk_urov_vnesh=pusk_urov_vnesh, IA=0, IB=0, IC=0)

        ss_prev_vrem_per_ka = self.tsa.Step(VYVOD=VYVOD, prev_vrem_ka=(uv_prev_vrem_per_cbcswi1_swctrl,))[10]

        pusk_t_lvalh = self.t_lvalh.Step(VYVOD=VYVOD, COMM_SIGN=(v_samoproisv_otkl_rcbf1_lvcbsup, neispr_V_rcbf1_lvcbsup), sgf9_sign=ss_prev_vrem_per_ka)
