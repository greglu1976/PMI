...
class part_LO:
    ...
    def Step(self, VYVOD,
        ...
        # вычисляем СС
        SS_gz_sign, SS_gz_nizk_isol, SS_gz_zablok, SS_tz_sign, SS_tz_nizk_isol, SS_tz_zablok, SS_ts_sign, SS_vnesh_otkl, SS_vyh_zepi_razobr, SS_bi_vyved, SS_ot_sign, SS_neispr_ot_gz, SS_neispr_ot_tz, SS_ot_nn_sign, SS_obsh_vnesh_sign = self.tsa.Step(VYVOD, gz_sign=(0,), gz_ki=(0,), gz_zablok=(0,), tz_sign=(0,), tz_ki=(0,), tz_zablok=(0,), ts_sign=(0,), vnesh_otkl=(vnesh_otkl_ot_so, vnesh_otkl_zdz1, vnesh_otkl_zdz2, vnesh_otkl_urov1, vnesh_otkl_urov2), Polozh_SA1=Polozh_SA1, Polozh_SA2=Polozh_SA2, Polozh_SA3=Polozh_SA3, Polozh_SA4=Polozh_SA4, Polozh_SG1=Polozh_SG1, Polozh_SG2=Polozh_SG2, Polozh_SG3=Polozh_SG3, ot_gz=ot_gz, ot_tz=ot_tz, ot_zdz_nn1=ot_zdz_nn1, ot_zdz_nn2=ot_zdz_nn2, ot_urov_nn1=ot_urov_nn1, ot_urov_nn2=ot_urov_nn2, vnesh_sign=(vnesh_sign1, vnesh_sign2,vnesh_sign3,vnesh_sign4))
