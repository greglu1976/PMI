...
from lib._FBS.LVTTOC_T import LVTTOC # импорт ФБ МТЗ Т
...
class partOfFsuInTOC:
    ...
    def Step(self, VYVOD, OV_lvttoc, SV1vkl, IA, dIA, IB, dIB, IC, dIC, VNN1vkl, 
        ...
        # вычисляем ПС
        pusk_lvalv = self.lvalv.Step(VYVOD, COMM_SIGN = (mtz_srabsign_ptoc1_lvttoc, mtz_srabsign_ptoc2_lvttoc, mtz_srabsign_ptoc3_lvttoc, srab_ptrc1, neispr_zn_lvrbvtr1))
