...
class part_LO:
    ...
    def Step(self, VYVOD, 
        ...
        # вычисляем ПС
        pusk_lvalv = self.lvalv.Step(VYVOD, (srab_ptrc1_tofflvlgc, srab_rbrf1_tpbrf, srab_na_sebya_rbrf1_tpbrf, neispr_V_rcbf1_lvcbsup, v_samoproisv_otkl_rcbf1_lvcbsup), SS_gz_sign, SS_gz_nizk_isol, SS_gz_zablok, SS_tz_sign, SS_tz_nizk_isol, SS_tz_zablok, SS_ts_sign, SS_ot_sign, SS_ot_nn_sign, SS_vnesh_otkl, SS_vyh_zepi_razobr, SS_bi_vyved, SS_prev_vrem_per_ka, SS_obsh_vnesh_sign)
