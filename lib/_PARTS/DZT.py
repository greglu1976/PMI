...
class partDZT:
    ...
    def Step(self, VYVOD, OV_ctr, OVst_rctr1, IA_1, dIA_1, IB_1, dIB_1, IC_1, dIC_1, OVst_rctr2, IA_2, dIA_2, IB_2, dIB_2, IC_2, dIC_2, OV_tdif, OV_pdif1_tdif, NaSign_pdif1_tdif, OV_pdif2_tdif, NaSign_pdif2_tdif, IA2harm, IB2harm, IC2harm, IA5harm, IB5harm, IC5harm, OV_rctr1_tdif, OV_tprmofflvlgc, OV_ptrc1_tprmofflvlgc, OV_rbre1_tprmofflvlgc):
        ...
        pusk_lvalh = self.lvalh.Step(VYVOD, COMM_SIGN = (srab_pdif2_tdif, srab_pdif1_tdif))
