# ФБ ДЗТ для динамического вычисления дифтоков 2 и 5 гармоник
# 
...
class TDIF:
    def __init__(self, 
        Sbaz, Ubaz_vn, Ubaz_nn, Iperv_vn, Iperv_nn, Inom_term_vn, Inom_term_nn, Ivtor_vn, Ivtor_nn, k_sch_vn, k_sch_nn, n_sch_vn, n_sch_nn, compens_3i0_vn, compens_3i0_nn,
        ...
        self.calc = CalcDiffBias(Sbaz, Ubaz_vn, Ubaz_nn, Iperv_vn, Iperv_nn, Inom_term_vn, Inom_term_nn, Ivtor_vn, Ivtor_nn, k_sch_vn, k_sch_nn, n_sch_vn, n_sch_nn, compens_3i0_vn, compens_3i0_nn)

        self.calc2h = CalcDiffBias(Sbaz, Ubaz_vn, Ubaz_nn, Iperv_vn, Iperv_nn, Inom_term_vn, Inom_term_nn, Ivtor_vn, Ivtor_nn, k_sch_vn, k_sch_nn, n_sch_vn, n_sch_nn, compens_3i0_vn, compens_3i0_nn)

        self.calc5h = CalcDiffBias(Sbaz, Ubaz_vn, Ubaz_nn, Iperv_vn, Iperv_nn, Inom_term_vn, Inom_term_nn, Ivtor_vn, Ivtor_nn, k_sch_vn, k_sch_nn, n_sch_vn, n_sch_nn, compens_3i0_vn, compens_3i0_nn)
    ...
    def Step(self, VYVOD, IA_vn, dIA_vn, IB_vn, dIB_vn, IC_vn, dIC_vn, IA_nn, dIA_nn, IB_nn, dIB_nn, IC_nn, dIC_nn, OV_tdif, OV_pdif2_tdif, NaSign_pdif2_tdif, OV_pdif1_tdif, NaSign_pdif1_tdif, CurCirc, IAdiff2h, IBdiff2h, ICdiff2h, IAdiff5h, IBdiff5h, ICdiff5h, OV_rctr1_tdif):
        ...
        diff_currs2h, bias_currs2h  = self.calc2h.Step(IAdiff2h, dIA_vn, IBdiff2h, dIB_vn, ICdiff2h, dIC_vn, IA_nn=0, dIA_nn=0, IB_nn=0, dIB_nn=0, IC_nn=0, dIC_nn=0)
