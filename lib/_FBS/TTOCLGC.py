...
from lib._FUNCS.TLGCPTRC import TLGCPTRC # импортируем функцию ЛЗТ

class TTOCLGC:
    def __init__(self, SGF1_ptrc1_ttoclgc, SGF2_ptrc1_ttoclgc, SGF3_ptrc1_ttoclgc, T1_ptrc1_ttoclgc):
        self.ptrc1 = TLGCPTRC(SGF1_ptrc1_ttoclgc, SGF2_ptrc1_ttoclgc, SGF3_ptrc1_ttoclgc, T1_ptrc1_ttoclgc)
...
if __name__ == "__main__":
    fb = TTOCLGC(SGF1=1, SGF1=1, T1=0, Iset=1)
