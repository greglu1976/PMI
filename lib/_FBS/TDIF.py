...
class TDIF:
    ...
    def Step(self, VYVOD, IA_vn, dIA_vn, IB_vn, dIB_vn, IC_vn, dIC_vn, IA_nn, dIA_nn, IB_nn, dIB_nn, IC_nn, dIC_nn, OV_tdif, OV_pdif2_tdif, NaSign_pdif2_tdif, OV_pdif1_tdif, NaSign_pdif1_tdif, CurCirc, IAdiff2h, IBdiff2h, ICdiff2h, IAdiff5h, IBdiff5h, ICdiff5h, OV_rctr1_tdif):
        ...
        pusk_A_hf2phar1_tdif, pusk_B_hf2phar1_tdif, pusk_C_hf2phar1_tdif, pusk_hf2phar1_tdif = self.hf2phar1.Step(vvod_pdif1_tdif, diff_currs[0][0], (IAdiff2h/100)* diff_currs[0][0], diff_currs[1][0], (IBdiff2h/100)* diff_currs[1][0], diff_currs[2][0], (ICdiff2h/100)* diff_currs[2][0])

        # вычисляем 5 гармонику в диф токе
        pusk_A_hf5phar1_tdif, pusk_B_hf5phar1_tdif, pusk_C_hf5phar1_tdif, pusk_hf5phar1_tdif = self.hf5phar1.Step(vvod_pdif1_tdif, diff_currs[0][0], (IAdiff5h/100)* diff_currs[0][0], diff_currs[1][0], (IBdiff5h/100)* diff_currs[1][0], diff_currs[2][0], (ICdiff5h/100)* diff_currs[2][0])
