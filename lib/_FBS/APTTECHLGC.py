...
class APTTECHLGC:
    def __init__(self, SGF1_oilptrc1_apttechlgc, SGF2_oilptrc1_apttechlgc,T1_oilptrc1_apttechlgc,
                    SGF1_winptrc1_apttechlgc, SGF2_winptrc1_apttechlgc, T1_winptrc1_apttechlgc,
                    SGF1_vlvptrc1_apttechlgc, SGF2_vlvptrc1_apttechlgc, T1_vlvptrc1_apttechlgc,
    ):
        self.oilptrc1 = TECHPTRC_3(SGF1_oilptrc1_apttechlgc, SGF2_oilptrc1_apttechlgc, T1_oilptrc1_apttechlgc)
        self.winptrc1 = TECHPTRC_3(SGF1_winptrc1_apttechlgc, SGF2_winptrc1_apttechlgc, T1_winptrc1_apttechlgc)
        self.vlvptrc1 = TECHPTRC(SGF1_vlvptrc1_apttechlgc, SGF2_vlvptrc1_apttechlgc, T1_vlvptrc1_apttechlgc)
    ...
    def Step(self, VYVOD, OV_tz, OV_dtm, OV_dto, OV_rd, NaSign_dtm, NaSign_dto, NaSign_rd, srabKontOtkl_m, srabKontSign_m, srabKontOtkl_o, srabKontSign_o, srabKontOtkl_rd, srabKI_m, srabKI_o, srabKI_rd, Sbros):
        ...
        print(zablok_oilptrc1_apttechlgc)
