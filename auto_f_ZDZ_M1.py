...
import itertools
import openpyxl
from lib._FUNCS.STRPTOC_M1 import STRPTOC  # Импортируем новый класс

class ZDZ_GUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Тестирование ЗДЗ М1-СВ")
        self.lvcbxcbr = None
        ...
        self.settings = {
            ...
            "U0set": tk.DoubleVar(value=10),  # Таймер 2
        }

        # Инициализация переменных для входных значений
        self.input_vars = {
            "OV": tk.IntVar(value=0), 
            "zdz1": tk.IntVar(value=0), 
            "zdz2": tk.IntVar(value=0),  
    ...
    def create_widgets(self):
        ...
        outputs = [ "vvod", "obnaruzh_dugi", "neisp", "srab", "U0_3u0" ]
